// http://instafeedjs.com Generated by CoffeeScript 1.9.3
(function() {
    var e;
    e = function() {
        function e(e, t) {
...
var b = {
    ...
    showBarryAge: function() {
        var inner = document.getElementById('barry-age')
          , outer = document.getElementById('barry-age-sentence')
          , bday = new Date(1984,05,23)
          , currAge = this.calculateAge(bday);

        inner.innerHTML = currAge;
        outer.classList.add('ready');

    },

    showUserLifeCompletion: function() {
        var uAge = document.getElementById('user-age').value, uStat = Math.floor((uAge / 80) * 100), uPercents = document.getElementsByClassName('life-completion-percent'), message;

        if (uAge > 79) {
            uStat = 100;
            message = "Congratulations! You have met or exceeded a typical global life expectancy. What remains undone in your life?";
        } else {
            message = "If things go well for you, your life is " + uStat + "% complete. What will you do?";
        }
        document.getElementById('life-completion-bar').style.width = uStat + "%";

        document.getElementById('life-completion').classList.add('active');
        document.getElementById('life-completion-location').style.left = uStat + "%";
        document.getElementById('life-completion-location').classList.add('active');
        document.getElementById('life-completion-text').innerHTML = "<p>" + message + "</p>";
        document.getElementById('life-completion-text').focus();

    },
    // end showUserLifeCompletion

    instagramFeed: function() {
        var feed = new Instafeed({
            get: 'user',
            userId: 'barrytsmith',
            clientId: '63fe2b89310640688ac7b943b219c0db',
            limit: 1
        });
        feed.run();
    },
    ...
    init: function() {
        ...
        document.getElementById('user-age-form').onsubmit = function(e) {
            e.preventDefault();
            t.showUserLifeCompletion();
        }
    }
}
